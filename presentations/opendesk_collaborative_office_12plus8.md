...
<polygon points="0 0, 14 7, 0 14" fill="#000" />
</marker>
</defs>
...
<rect x="250" y="60" width="100" height="40" fill="#ECECFF" stroke="#333" stroke-width="2" rx="6" />
<text x="300" y="78" text-anchor="middle" font-family="Arial" font-size="14" fill="#333">Agent</text>
<text x="300" y="92" text-anchor="middle" font-family="Arial" font-size="10" fill="#666">(Schlägt vor)</text>
<path d="M135 75 L250 75" stroke="#000" stroke-width="2" marker-end="url(#hitl-arrow)" />
<path d="M300 75 L135 75" stroke="#000" stroke-width="2" marker-end="url(#hitl-arrow)" />
...
<path d="M310 60 L310 100" stroke="#000" stroke-width="2" marker-end="url(#arch-arrow)" />
<path d="M150 100 L100 120" stroke="#000" stroke-width="2" marker-end="url(#arch-arrow)" />
<path d="M230 100 L230 120" stroke="#000" stroke-width="2" marker-end="url(#arch-arrow)" />
<path d="M360 100 L360 120" stroke="#000" stroke-width="2" marker-end="url(#arch-arrow)" />
<path d="M490 100 L490 120" stroke="#000" stroke-width="2" marker-end="url(#arch-arrow)" />
<path d="M230 135 L280 180" stroke="#000" stroke-width="2" marker-end="url(#arch-arrow)" />
<path d="M150 135 L280 180" stroke="#000" stroke-width="2" marker-end="url(#arch-arrow)" />
<path d="M360 135 L380 180" stroke="#000" stroke-width="2" marker-end="url(#arch-arrow)" />
<path d="M490 135 L380 180" stroke="#000" stroke-width="2" marker-end="url(#arch-arrow)" />
<path d="M330 215 L330 230" stroke="#000" stroke-width="2" marker-end="url(#arch-arrow)" />
...
<path d="M360 55 L360 80" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M170 115 L170 140" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M350 115 L350 140" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M530 115 L530 140" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M170 130 L200 160" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M350 130 L380 160" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M270 175 L270 220" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M350 175 L350 220" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M530 175 L350 220" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M200 255 L200 280" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M350 255 L350 280" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M450 255 L450 280" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M600 255 L560 280" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M370 305 L370 340" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M270 315 L300 340" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M450 315 L380 340" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
<path d="M600 315 L480 340" stroke="#000" stroke-width="2" marker-end="url(#stack-arrow)" />
</svg>
</div>
