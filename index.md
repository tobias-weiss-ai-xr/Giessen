...
| Datum | Thema |
| ---------- | ------------|
| 24.06.2026 | **Digitalisierung an der JLU**<br>Marcus Enger leitet an der JLU das Büro für Digitalisierung und trägt dort mit seinem Team zur digitalen Transformation der lokalen Hochschullandschaft bei. In seinem Vortrag zeigt er praxisnah, wie mit Hilfe eines IT-Bebauungsplans die Systemlandschaft zum zentralen Betrieb der JLU systematisch erfasst und strukturiert wurde, welche neuen Teilhabemöglichkeiten sich für JLU-Angehörige ergeben und wie konkrete Digitalisierungsprojekte durch Anwenderbeteiligung erfolgreich in die Praxis umgesetzt werden konnten. Im Anschluss gibt es Raum für Fragen und Diskussionen. Vortragssprache: Deutsch<br><br>**JLU KI-Chat ohne Browser nutzen.**<br>Steffen Karcher ist Systemadministrator am HRZ und zeigt am Beispiel "Programmieren mit KI", wie man die KI-Modelle des HRZ auch lokal einbinden kann. Vortragssprache: Deutsch|
| 22.07.2026 | Die HackyHour macht Sommerpause 🏖️ |
| 26.08.2026 | **Agentic AI in der Praxis**<br>Christian Uhl forscht am Zentrum für angewandte Informatik und Data Science mit Schwerpunkt Künstliche Intelligenz. In seinem Vortrag zeigt er praxisnah, wie Large Language Models heute agentisch genutzt werden können, welche neuen Möglichkeiten sich daraus ergeben und wie solche Ansätze sinnvoll in eigene Projekte integriert werden können. Im Anschluss gibt es Raum für Fragen, Diskussion und konkrete Anwendungsfälle aus der Praxis. Vortragssprache: Deutsch<br><br>Im Anschluss stellt Tobias Weiß ([tobias-weiss.org](https://tobias-weiss.org/)), DevOps Engineer an der Uni Marburg, die Kollaborations-, Lern- und Forschungsplattform [OpenDesk Edu](https://opendesk-edu.org/) als einen praktischen Use Case für Agentic Engineering vor. **[Slides ✨](/presentations/opendesk_edu_12plus8.html)** |
| 23.09.2026 | **Publikationspipeline mit Pandoc**<br>Christian Krippes ist Mitarbeiter der UB. In seinem Vortrag stellt er vor, wie man mithilfe von Pandoc seine Texte in multiplen Formaten erzeugen und so an unterschiedliche Zielgruppen ausspielen kann. Vortragssprache: Deutsch<br> |
